...
func (api *API) endpoints() {
	api.router.HandleFunc("/posts", api.getAllPostsHandler).Methods(http.MethodGet, http.MethodOptions)
...
func (api *API) getAllPostsHandler(w http.ResponseWriter, r *http.Request) {
	posts, err := api.db.GetAllPosts()
	if err != nil {
